...
#Paddle A Starting Pos
PaddleA_Starting_Posx = 16
PaddleA_Starting_Posy = Screen_Height/2 - 16

#Paddle B Starting pos
PaddleB_Starting_Posx = Screen_Width - 16
PaddleB_Starting_Posy = Screen_Height/2 - 16

PaddleA_Starting_MomentumY = 0
PaddleB_Starting_MomentumY = 0

pygame.draw.rect(screen, WHITE, (PaddleA_Starting_Posx, PaddleA_Starting_Posy, 16, 96))
pygame.draw.rect(screen, WHITE, (PaddleB_Starting_Posx, PaddleB_Starting_Posy, 16, 96))
...
#Detecting keypresses and moving the paddle acoridingly
    keys = pygame.key.get_pressed()

    if keys[pygame.K_w]:
        pygame.draw.rect(screen, BLACK, (PaddleB_Starting_Posx, PaddleA_Starting_Posy - PaddleA_Starting_MomentumY, 16, 96))
        print("UP!")
        PaddleA_Starting_MomentumY += 20
        pygame.draw.rect(screen, WHITE, (PaddleA_Starting_Posx, PaddleA_Starting_Posy - PaddleA_Starting_MomentumY, 16, 96))
...
# Draws the borders of the screen every time the loop runs
    ...
    pygame.draw.rect(screen, BLACK, (0, Scoreboard_Height, Net_Edge_Left, Scoreboard_Height+16))
...
#draw the paddles again **
    pygame.draw.rect(screen, WHITE, (PaddleA_Starting_Posx, PaddleA_Starting_Posy - PaddleA_Starting_MomentumY, 16, 96))
    pygame.draw.rect(screen, WHITE, (PaddleB_Starting_Posx, PaddleB_Starting_Posy - PaddleB_Starting_MomentumY, 16, 96))
